...
void mainmenu()
{
  ...
  case '4':
    ...
    printf("Programmers....");
    gotoxy(16,4);
    printf("1. abc       (066/BCT/506)");
    gotoxy(16,5);
    printf("   mobile:12345  E-mail:abc.gmail.com");
    gotoxy(16,7);
    printf("2. abc      (066/BCT/512)");
    gotoxy(16,8);
    printf("   Mobile:123  E-mail:abc@gmail.com");
    gotoxy(16,10);
    printf("3. abc      (066/BCT/537)");
    gotoxy(16,11);
    printf("   Mobile:abc   E-mail:abc@yahoo.com");
    gotoxy(16,13);
    printf("With  the Unexplainable Help of abc");
    gotoxy(10,17);
